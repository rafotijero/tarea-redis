package com.rafo.apps.task_retrofit.utils;
...
public class Constants {
    ...
    public static final String CLIENT = "[Cliente: Retrofit]";
    public static final String MESSAGE_RETROFIT = "CREANDO CLIENTE RETROFIT CON URL Y PARAMETROS(SIN VALORES)";
